...
class ConditionalSingleFieldDependency:
    ...
    def __init__(
        self,
        dependency_type="CONDITIONAL_SINGLE_FIELD",
        dependent_field_names=None,
        controlling_field_name=None,
        controlling_field_value=None,
    ...
    def dependency_type(self):
        """Gets the dependency_type of this ConditionalSingleFieldDependency.  # noqa: E501


        :return: The dependency_type of this ConditionalSingleFieldDependency.  # noqa: E501
        :rtype: str
        """
    ...
    def dependency_type(self, dependency_type):
        """Sets the dependency_type of this ConditionalSingleFieldDependency.
        ...
        if (
            ...
            raise ValueError(
                "Invalid value for `dependency_type` ({}), must be one of {}".format(  # noqa: E501
    ...
    def dependent_field_names(self):
        """Gets the dependent_field_names of this ConditionalSingleFieldDependency.  # noqa: E501


        :return: The dependent_field_names of this ConditionalSingleFieldDependency.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def dependent_field_names(self, dependent_field_names):
        """Sets the dependent_field_names of this ConditionalSingleFieldDependency.
    ...
    def controlling_field_name(self):
        """Gets the controlling_field_name of this ConditionalSingleFieldDependency.  # noqa: E501


        :return: The controlling_field_name of this ConditionalSingleFieldDependency.  # noqa: E501
        :rtype: str
        """
    ...
    def controlling_field_name(self, controlling_field_name):
        """Sets the controlling_field_name of this ConditionalSingleFieldDependency.
    ...
    def controlling_field_value(self):
        """Gets the controlling_field_value of this ConditionalSingleFieldDependency.  # noqa: E501


        :return: The controlling_field_value of this ConditionalSingleFieldDependency.  # noqa: E501
        :rtype: str
        """
    ...
    def controlling_field_value(self, controlling_field_value):
        """Sets the controlling_field_value of this ConditionalSingleFieldDependency.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConditionalSingleFieldDependency):
            return False
