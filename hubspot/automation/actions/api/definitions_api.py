...
class DefinitionsApi(object):
    ...
    def create_with_http_info(self, app_id, extension_action_definition_input, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('extension_action_definition_input' not in local_var_params or  # noqa: E501
                                                        local_var_params['extension_action_definition_input'] is None):  # noqa: E501
    ...
    def update_with_http_info(self, definition_id, app_id, extension_action_definition_patch, **kwargs):  # noqa: E501
        ...
        all_params = [
            'definition_id',
            'app_id',
            'extension_action_definition_patch'
        ]
        all_params.extend(
            [
                'async_req',
        ...
        if self.api_client.client_side_validation and ('extension_action_definition_patch' not in local_var_params or  # noqa: E501
                                                        local_var_params['extension_action_definition_patch'] is None):  # noqa: E501
