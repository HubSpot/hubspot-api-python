...
class RefreshTokenInfoResponse(object):
    ...
    """
    openapi_types = {"client_id": "str", "hub_domain": "str", "hub_id": "int", "scopes": "list[str]", "token": "str", "token_type": "str", "user": "str", "user_id": "int"}

    attribute_map = {"client_id": "client_id", "hub_domain": "hub_domain", "hub_id": "hub_id", "scopes": "scopes", "token": "token", "token_type": "token_type", "user": "user", "user_id": "user_id"}

    def __init__(self, client_id=None, hub_domain=None, hub_id=None, scopes=None, token=None, token_type=None, user=None, user_id=None, local_vars_configuration=None):  # noqa: E501
    ...
    def client_id(self):
        ...
        The client ID of the application that the refresh token was issued for.  # noqa: E501
    ...
    def hub_domain(self):
        ...
        The domain of the HubSpot account associated with the refresh token.  # noqa: E501
    ...
    def hub_id(self):
        ...
        The ID of the HubSpot account associated with the refresh token.  # noqa: E501
    ...
    def token_type(self):
        ...
        The type of token, typically indicating the OAuth token type. Typically `bearer`.  # noqa: E501
    ...
    def user(self):
        ...
        The email address of the hubspot user associated with the refresh token.  # noqa: E501
    ...
    def user_id(self):
        ...
        The ID of the hubspot user associated with the refresh token.  # noqa: E501
