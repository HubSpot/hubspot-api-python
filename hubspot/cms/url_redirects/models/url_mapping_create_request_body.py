...
class UrlMappingCreateRequestBody(object):
    ...
    def __init__(self, route_prefix=None, destination=None, redirect_style=None, precedence=None, is_only_after_not_found=None, is_match_full_url=None, is_match_query_string=None, is_pattern=None, is_trailing_slash_optional=None, is_protocol_agnostic=None, local_vars_configuration=None):  # noqa: E501
