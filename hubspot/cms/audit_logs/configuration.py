...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of hubspot.cms.audit_logs.signing.HttpSigningConfiguration
    ...
    Note you can use the constants defined in the hubspot.cms.audit_logs.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = hubspot.cms.audit_logs.Configuration(
        signing_info = hubspot.cms.audit_logs.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
