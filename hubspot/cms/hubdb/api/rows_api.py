...
class RowsApi(object):
    ...
    def clone_draft_table_row(self, table_id_or_name, row_id, **kwargs):  # noqa: E501
        ...
        :type row_id: str
        :param name: The name for the cloned row.
        :type name: str
    ...
    def get_draft_table_row_by_id(self, table_id_or_name, row_id, **kwargs):  # noqa: E501
        ...
        :param row_id: The ID of the row (required)
        :type row_id: str
        :param archived: Set this to `true` to return an archived row. Defaults to `false`.
        :type archived: bool
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
    ...
    def get_table_row(self, table_id_or_name, row_id, **kwargs):  # noqa: E501
        ...
        :param row_id: The ID of the row (required)
        :type row_id: str
        :param archived: Specifies whether to return an archived row. Defaults to `false`.
        :type archived: bool
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
    ...
    def get_table_rows(self, table_id_or_name, **kwargs):  # noqa: E501
        ...
        :type offset: int
        :param archived: Specifies whether to include archived rows in the response.
        :type archived: bool
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
    ...
    def read_draft_table_rows(self, table_id_or_name, **kwargs):  # noqa: E501
        ...
        :param offset: The number of rows to skip before starting to return results.
        :type offset: int
        :param archived: Specifies whether to return archived rows. Defaults to `false`.
        :type archived: bool
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
