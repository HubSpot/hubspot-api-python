...
class TablesApi(object):
    ...
    def get_all_draft_tables(self, **kwargs):  # noqa: E501
        ...
        :param content_type: Specifies the content type for the response.
        :type content_type: str
        :param archived: Specifies whether to return archived tables. Defaults to `false`.
        :type archived: bool
        :param is_get_localized_schema: Indicates whether to retrieve the localized schema.
    ...
    def get_all_draft_tables_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ["sort", "after", "limit", "created_at", "created_after", "created_before", "updated_at", "updated_after", "updated_before", "content_type", "archived", "is_get_localized_schema"]
        all_params.extend(["async_req", "_return_http_data_only", "_preload_content", "_request_timeout", "_request_auth", "_content_type", "_headers"])
    ...
    def get_all_tables(self, **kwargs):  # noqa: E501
        ...
        :param archived: Specifies whether to return archived tables. Defaults to `false`.
        :type archived: bool
        :param is_get_localized_schema: Indicates whether to retrieve the localized schema for the tables.
        :type is_get_localized_schema: bool
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
    ...
    def get_draft_table_details_by_id(self, table_id_or_name, **kwargs):  # noqa: E501
        ...
        :type table_id_or_name: str
        :param is_get_localized_schema: Indicates whether to retrieve the localized schema for the table.
        :type is_get_localized_schema: bool
    ...
    def remove_table_version(self, table_id_or_name, version_id, **kwargs):  # noqa: E501
        """Delete a table version  # noqa: E501

        Delete a specific version of a table  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.remove_table_version(table_id_or_name, version_id, async_req=True)
        >>> result = thread.get()

        :param table_id_or_name: The ID or name of the table whose version is to be deleted. (required)
        :type table_id_or_name: str
        :param version_id: The ID of the specific version of the table to delete. (required)
        :type version_id: int
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
        ...
        """
        kwargs["_return_http_data_only"] = True
        return self.remove_table_version_with_http_info(table_id_or_name, version_id, **kwargs)  # noqa: E501

    def remove_table_version_with_http_info(self, table_id_or_name, version_id, **kwargs):  # noqa: E501
        """Delete a table version  # noqa: E501
        ...
        >>> thread = api.remove_table_version_with_http_info(table_id_or_name, version_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ["table_id_or_name", "version_id"]
        all_params.extend(["async_req", "_return_http_data_only", "_preload_content", "_request_timeout", "_request_auth", "_content_type", "_headers"])

        for key, val in six.iteritems(local_var_params["kwargs"]):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method remove_table_version" % key)
            local_var_params[key] = val
        del local_var_params["kwargs"]
        # verify the required parameter 'table_id_or_name' is set
        if self.api_client.client_side_validation and local_var_params.get("table_id_or_name") is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `table_id_or_name` when calling `remove_table_version`")  # noqa: E501
        # verify the required parameter 'version_id' is set
        if self.api_client.client_side_validation and local_var_params.get("version_id") is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `version_id` when calling `remove_table_version`")  # noqa: E501

        if self.api_client.client_side_validation and "version_id" in local_var_params and not re.search(r"\d+", local_var_params["version_id"]):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `version_id` when calling `remove_table_version`, must conform to the pattern `/\d+/`")  # noqa: E501
        collection_formats = {}
