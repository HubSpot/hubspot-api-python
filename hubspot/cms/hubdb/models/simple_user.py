...
class SimpleUser(object):
    ...
    """
    openapi_types = {"email": "str", "first_name": "str", "id": "str", "last_name": "str"}

    attribute_map = {"email": "email", "first_name": "firstName", "id": "id", "last_name": "lastName"}

    def __init__(self, email=None, first_name=None, id=None, last_name=None, local_vars_configuration=None):  # noqa: E501
