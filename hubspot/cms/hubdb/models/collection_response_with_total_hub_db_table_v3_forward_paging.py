...
class CollectionResponseWithTotalHubDbTableV3ForwardPaging(object):
    ...
    """
    openapi_types = {"paging": "ForwardPaging", "results": "list[HubDbTableV3]", "total": "int"}

    attribute_map = {"paging": "paging", "results": "results", "total": "total"}

    def __init__(self, paging=None, results=None, total=None, local_vars_configuration=None):  # noqa: E501
    ...
    def total(self):
        ...
        The total number of tables available in the collection.  # noqa: E501
