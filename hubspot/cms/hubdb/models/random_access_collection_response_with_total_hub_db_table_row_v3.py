...
class RandomAccessCollectionResponseWithTotalHubDbTableRowV3(object):
    ...
    """
    openapi_types = {"paging": "BoundedPaging", "results": "list[HubDbTableRowV3]", "total": "int", "type": "str"}

    attribute_map = {"paging": "paging", "results": "results", "total": "total", "type": "type"}

    def __init__(self, paging=None, results=None, total=None, type="RANDOM_ACCESS", local_vars_configuration=None):  # noqa: E501
    ...
    def total(self):
        ...
        The total number of rows available in the collection.  # noqa: E501
    ...
    def type(self):
        ...
        Indicates the type of response, which is 'RANDOM_ACCESS' by default.  # noqa: E501
