...
class HubDbTableCloneRequest(object):
    ...
    """
    openapi_types = {"copy_rows": "bool", "is_hubspot_defined": "bool", "new_label": "str", "new_name": "str"}

    attribute_map = {"copy_rows": "copyRows", "is_hubspot_defined": "isHubspotDefined", "new_label": "newLabel", "new_name": "newName"}

    def __init__(self, copy_rows=None, is_hubspot_defined=None, new_label=None, new_name=None, local_vars_configuration=None):  # noqa: E501
    ...
    def is_hubspot_defined(self):
        ...
        Indicates whether the table is defined by HubSpot.  # noqa: E501
