...
class Column(object):
    ...
    def __init__(self, name=None, label=None, id=None, width=None, foreign_table_id=None, foreign_column_id=None, foreign_ids=None, foreign_ids_by_name=None, foreign_ids_by_id=None, type=None, option_count=None, archived=None, options=None, local_vars_configuration=None):  # noqa: E501
    ...
    def type(self, type):
        ...
        allowed_values = ["NULL", "TEXT", "NUMBER", "URL", "IMAGE", "SELECT", "MULTISELECT", "BOOLEAN", "LOCATION", "DATE", "DATETIME", "CURRENCY", "RICHTEXT", "FOREIGN_ID", "VIDEO", "CTA"]  # noqa: E501
