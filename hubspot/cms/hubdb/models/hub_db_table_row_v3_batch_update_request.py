...
class HubDbTableRowV3BatchUpdateRequest(object):
    ...
    """
    openapi_types = {"child_table_id": "int", "display_index": "int", "id": "str", "name": "str", "path": "str", "values": "dict[str, object]"}

    attribute_map = {"child_table_id": "childTableId", "display_index": "displayIndex", "id": "id", "name": "name", "path": "path", "values": "values"}

    def __init__(self, child_table_id=None, display_index=None, id=None, name=None, path=None, values=None, local_vars_configuration=None):  # noqa: E501
