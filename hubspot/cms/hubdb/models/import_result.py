...
class ImportResult(object):
    ...
    """
    openapi_types = {"duplicate_rows": "int", "errors": "list[Error]", "row_limit_exceeded": "bool", "rows_imported": "int"}

    attribute_map = {"duplicate_rows": "duplicateRows", "errors": "errors", "row_limit_exceeded": "rowLimitExceeded", "rows_imported": "rowsImported"}

    def __init__(self, duplicate_rows=None, errors=None, row_limit_exceeded=None, rows_imported=None, local_vars_configuration=None):  # noqa: E501
