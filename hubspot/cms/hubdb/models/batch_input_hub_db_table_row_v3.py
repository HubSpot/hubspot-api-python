...
class BatchInputHubDbTableRowV3(object):
    ...
    """
    openapi_types = {"inputs": "list[HubDbTableRowV3]"}

    attribute_map = {"inputs": "inputs"}

    def __init__(self, inputs=None, local_vars_configuration=None):  # noqa: E501
        """BatchInputHubDbTableRowV3 - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def inputs(self):
        """Gets the inputs of this BatchInputHubDbTableRowV3.  # noqa: E501


        :return: The inputs of this BatchInputHubDbTableRowV3.  # noqa: E501
    ...
    def inputs(self, inputs):
        """Sets the inputs of this BatchInputHubDbTableRowV3.


        :param inputs: The inputs of this BatchInputHubDbTableRowV3.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchInputHubDbTableRowV3):
            return False
