...
class ActionResponse(object):
    ...
    """
    openapi_types = {"completed_at": "datetime", "links": "dict[str, str]", "requested_at": "datetime", "started_at": "datetime", "status": "str"}

    attribute_map = {"completed_at": "completedAt", "links": "links", "requested_at": "requestedAt", "started_at": "startedAt", "status": "status"}

    def __init__(self, completed_at=None, links=None, requested_at=None, started_at=None, status=None, local_vars_configuration=None):  # noqa: E501
