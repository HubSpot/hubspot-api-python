...
class AssetFileMetadata(object):
    ...
    """
    openapi_types = {"archived_at": "int", "children": "list[str]", "created_at": "int", "folder": "bool", "hash": "str", "id": "str", "name": "str", "updated_at": "int"}

    attribute_map = {"archived_at": "archivedAt", "children": "children", "created_at": "createdAt", "folder": "folder", "hash": "hash", "id": "id", "name": "name", "updated_at": "updatedAt"}

    def __init__(self, archived_at=None, children=None, created_at=None, folder=None, hash=None, id=None, name=None, updated_at=None, local_vars_configuration=None):  # noqa: E501
