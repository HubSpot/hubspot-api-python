...
"""
    ...
    API for managing and retrieving source code files and metadata  # noqa: E501
...
class ValidationApi(object):
    ...
    def do_validate(self, environment, path, **kwargs):  # noqa: E501
        ...
        >>> thread = api.do_validate(environment, path, async_req=True)
        >>> result = thread.get()
        ...
        return self.do_validate_with_http_info(environment, path, **kwargs)  # noqa: E501

    def do_validate_with_http_info(self, environment, path, **kwargs):  # noqa: E501
        """Validate the contents of a file  # noqa: E501
        ...
        >>> thread = api.do_validate_with_http_info(environment, path, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and local_var_params.get("environment") is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `environment` when calling `do_validate`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and "environment" in local_var_params and not re.search(r".+", local_var_params["environment"]):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `environment` when calling `do_validate`, must conform to the pattern `/.+/`")  # noqa: E501
