...
class PublicApi(object):
    ...
    def search_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['q', 'limit', 'offset', 'language', 'match_prefix', 'autocomplete', 'popularity_boost', 'boost_limit', 'boost_recent', 'table_id', 'hubdb_query', 'domain', 'type', 'path_prefix', '_property', 'length', 'group_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
