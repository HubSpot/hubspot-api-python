...
class BlogAuthor(object):
    ...
    def __init__(self, id=None, full_name=None, email=None, slug=None, language=None, translated_from_id=None, name=None, display_name=None, bio=None, website=None, twitter=None, facebook=None, linkedin=None, avatar=None, created=None, updated=None, deleted_at=None, local_vars_configuration=None):  # noqa: E501
