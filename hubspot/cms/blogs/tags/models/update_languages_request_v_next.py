...
class UpdateLanguagesRequestVNext(object):
    ...
    def languages(self, languages):
        ...
        if (self.local_vars_configuration.client_side_validation and
                not set(languages.keys()).issubset(set(allowed_values))):  # noqa: E501
            raise ValueError(
                "Invalid keys in `languages` [{0}], must be a subset of [{1}]"  # noqa: E501
                .format(", ".join(map(str, set(languages.keys()) - set(allowed_values))),  # noqa: E501
