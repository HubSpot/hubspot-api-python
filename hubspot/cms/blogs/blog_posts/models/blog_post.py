...
class BlogPost:
    ...
    def ab_status(self, ab_status):
        ...
        if (
            ...
            raise ValueError(
                "Invalid value for `ab_status` ({}), must be one of {}".format(  # noqa: E501
    ...
    def language(self, language):
        ...
        if (
            ...
            raise ValueError(
                "Invalid value for `language` ({}), must be one of {}".format(  # noqa: E501
    ...
    def content_type_category(self, content_type_category):
        ...
        if (
            ...
            raise ValueError(
                "Invalid value for `content_type_category` ({}), must be one of {}".format(  # noqa: E501
    ...
    def current_state(self, current_state):
        ...
        if (
            ...
            raise ValueError(
                "Invalid value for `current_state` ({}), must be one of {}".format(  # noqa: E501
