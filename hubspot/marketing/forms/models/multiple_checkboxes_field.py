...
class MultipleCheckboxesField(object):
    ...
    def __init__(self, field_type='multiple_checkboxes', object_type_id=None, name=None, label=None, description=None, required=None, hidden=None, dependent_fields=None, default_values=None, options=None, local_vars_configuration=None):  # noqa: E501
