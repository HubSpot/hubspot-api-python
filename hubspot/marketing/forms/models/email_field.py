...
class EmailField(object):
    ...
    def __init__(self, field_type='email', object_type_id=None, name=None, label=None, description=None, required=None, hidden=None, dependent_fields=None, placeholder=None, default_value=None, validation=None, local_vars_configuration=None):  # noqa: E501
