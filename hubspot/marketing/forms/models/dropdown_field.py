...
class DropdownField(object):
    ...
    def __init__(self, field_type='dropdown', object_type_id=None, name=None, label=None, description=None, required=None, hidden=None, dependent_fields=None, default_values=None, options=None, placeholder=None, local_vars_configuration=None):  # noqa: E501
