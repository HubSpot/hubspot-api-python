...
class EmailsApi(object):
    ...
    def archive(self, email_id, **kwargs):  # noqa: E501
        ...
        Delete a marketing email by its ID  # noqa: E501
    ...
    def clone(self, email_clone_request_v_next, **kwargs):  # noqa: E501
        ...
        >>> thread = api.clone(email_clone_request_v_next, async_req=True)
        >>> result = thread.get()

        :param email_clone_request_v_next: (required)
        :type email_clone_request_v_next: EmailCloneRequestVNext
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        """
        kwargs["_return_http_data_only"] = True
        return self.clone_with_http_info(email_clone_request_v_next, **kwargs)  # noqa: E501

    def clone_with_http_info(self, email_clone_request_v_next, **kwargs):  # noqa: E501
        """Clone a marketing email  # noqa: E501
        ...
        >>> thread = api.clone_with_http_info(email_clone_request_v_next, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ["email_clone_request_v_next"]
        all_params.extend(["async_req", "_return_http_data_only", "_preload_content", "_request_timeout", "_request_auth", "_content_type", "_headers"])
        ...
        if self.api_client.client_side_validation and local_var_params.get("email_clone_request_v_next") is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `email_clone_request_v_next` when calling `clone`")  # noqa: E501
        ...
        body_params = None
        if "email_clone_request_v_next" in local_var_params:
            body_params = local_var_params["email_clone_request_v_next"]
        # HTTP header `Accept`
    ...
    def get_ab_test_variation_with_http_info(self, email_id, **kwargs):  # noqa: E501
        ...
        all_params = ["email_id", "archived", "included_properties", "include_stats", "marketing_campaign_names", "variant_stats", "workflow_names"]
        all_params.extend(["async_req", "_return_http_data_only", "_preload_content", "_request_timeout", "_request_auth", "_content_type", "_headers"])
        ...
        if local_var_params.get("variant_stats") is not None:  # noqa: E501
            query_params.append(("variantStats", local_var_params["variant_stats"]))  # noqa: E501
    ...
    def get_by_id_with_http_info(self, email_id, **kwargs):  # noqa: E501
        ...
        all_params = ["email_id", "include_stats", "marketing_campaign_names", "workflow_names", "included_properties", "archived", "variant_stats"]
        all_params.extend(["async_req", "_return_http_data_only", "_preload_content", "_request_timeout", "_request_auth", "_content_type", "_headers"])
    ...
    def get_page(self, **kwargs):  # noqa: E501
        """Get all marketing emails  # noqa: E501
    ...
    def get_page_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if local_var_params.get("archived") is not None:  # noqa: E501
            query_params.append(("archived", local_var_params["archived"]))  # noqa: E501
        if local_var_params.get("campaign") is not None:  # noqa: E501
            query_params.append(("campaign", local_var_params["campaign"]))  # noqa: E501
        if local_var_params.get("published_after") is not None:  # noqa: E501
            query_params.append(("publishedAfter", local_var_params["published_after"]))  # noqa: E501
        if local_var_params.get("published_at") is not None:  # noqa: E501
            query_params.append(("publishedAt", local_var_params["published_at"]))  # noqa: E501
        if local_var_params.get("published_before") is not None:  # noqa: E501
            query_params.append(("publishedBefore", local_var_params["published_before"]))  # noqa: E501
        if local_var_params.get("variant_stats") is not None:  # noqa: E501
            query_params.append(("variantStats", local_var_params["variant_stats"]))  # noqa: E501
    ...
    def get_revisions(self, email_id, **kwargs):  # noqa: E501
        ...
        Get a list of all versions of a marketing email, with each entry including the full state of that particular version. To view the most recent version, sort by the updatedAt parameter.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def reset_draft(self, email_id, **kwargs):  # noqa: E501
        """Reset the draft version  # noqa: E501
