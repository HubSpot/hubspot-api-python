...
class VersionUser(object):
    ...
    """
    openapi_types = {"email": "str", "full_name": "str", "id": "str"}

    attribute_map = {"email": "email", "full_name": "fullName", "id": "id"}

    def __init__(self, email=None, full_name=None, id=None, local_vars_configuration=None):  # noqa: E501
