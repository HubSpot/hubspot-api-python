...
class PublicRssEmailDetails(object):
    ...
    def blog_layout(self, blog_layout):
        ...
        """
        allowed_values = ["FULL_POST", "SUMMARY_NO_FEATURED_IMAGE", "SUMMARY_WITH_FEATURED_IMAGE"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and blog_layout not in allowed_values:  # noqa: E501
            raise ValueError("Invalid value for `blog_layout` ({0}), must be one of {1}".format(blog_layout, allowed_values))  # noqa: E501
