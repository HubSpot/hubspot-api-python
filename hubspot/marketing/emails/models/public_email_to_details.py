...
class PublicEmailToDetails(object):
    ...
    def __init__(self, contact_ids=None, contact_ils_lists=None, contact_lists=None, limit_send_frequency=None, suppress_graymail=None, local_vars_configuration=None):  # noqa: E501
    ...
    def suppress_graymail(self):
        ...
        Whether to send to unengaged contacts (false) or not (true).  # noqa: E501
