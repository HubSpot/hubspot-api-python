...
class PublicEmailStyleSettings(object):
    ...
    def background_image_type(self, background_image_type):
        ...
        """
        allowed_values = ["REPEAT", "SINGLE", "STRETCH"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and background_image_type not in allowed_values:  # noqa: E501
            raise ValueError("Invalid value for `background_image_type` ({0}), must be one of {1}".format(background_image_type, allowed_values))  # noqa: E501
    ...
    def secondary_font_size(self, secondary_font_size):
        ...
        :type secondary_font_size: float
        """
