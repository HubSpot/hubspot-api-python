...
class AggregateEmailStatistics(object):
    ...
    """
    openapi_types = {"aggregate": "EmailStatisticsData", "campaign_aggregations": "dict[str, EmailStatisticsData]", "emails": "list[int]"}

    attribute_map = {"aggregate": "aggregate", "campaign_aggregations": "campaignAggregations", "emails": "emails"}

    def __init__(self, aggregate=None, campaign_aggregations=None, emails=None, local_vars_configuration=None):  # noqa: E501
