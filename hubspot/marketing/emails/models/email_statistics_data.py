...
class EmailStatisticsData(object):
    ...
    """
    openapi_types = {"counters": "dict[str, int]", "device_breakdown": "dict[str, dict[str, int]]", "qualifier_stats": "dict[str, dict[str, int]]", "ratios": "dict[str, float]"}

    attribute_map = {"counters": "counters", "device_breakdown": "deviceBreakdown", "qualifier_stats": "qualifierStats", "ratios": "ratios"}

    def __init__(self, counters=None, device_breakdown=None, qualifier_stats=None, ratios=None, local_vars_configuration=None):  # noqa: E501
