...
class PublicFontStyle(object):
    ...
    """
    openapi_types = {"bold": "bool", "color": "str", "font": "str", "italic": "bool", "size": "int", "underline": "bool"}

    attribute_map = {"bold": "bold", "color": "color", "font": "font", "italic": "italic", "size": "size", "underline": "underline"}

    def __init__(self, bold=None, color=None, font=None, italic=None, size=None, underline=None, local_vars_configuration=None):  # noqa: E501
