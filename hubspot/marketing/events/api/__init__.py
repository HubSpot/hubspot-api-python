...
from hubspot.marketing.events.api.attendance_subscriber_state_changes_api import (
    AttendanceSubscriberStateChangesApi,
)
from hubspot.marketing.events.api.marketing_events_external_api import (
