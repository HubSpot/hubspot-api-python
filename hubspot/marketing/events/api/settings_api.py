...
class SettingsApi(object):
    ...
    def create(self, app_id, event_detail_settings_url, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create(app_id, event_detail_settings_url, async_req=True)
        >>> result = thread.get()

        :param app_id: The id of the application to update the settings for. (required)
        :type app_id: int
        :param event_detail_settings_url: The new application settings (required)
        ...
        return self.create_with_http_info(app_id, event_detail_settings_url, **kwargs)  # noqa: E501

    def create_with_http_info(self, app_id, event_detail_settings_url, **kwargs):  # noqa: E501
        """Update the application settings  # noqa: E501
        ...
        if self.api_client.client_side_validation and local_var_params.get("event_detail_settings_url") is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `event_detail_settings_url` when calling `create`")  # noqa: E501
