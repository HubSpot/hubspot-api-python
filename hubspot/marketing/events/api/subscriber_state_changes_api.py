...
class SubscriberStateChangesApi(object):
    ...
    def do_email_upsert_by_id(self, external_event_id, subscriber_state, external_account_id, batch_input_marketing_event_email_subscriber, **kwargs):  # noqa: E501
        ...
        Record a subscription state between multiple HubSpot contacts and a marketing event, using contact email addresses. Note that the contact must already exist in HubSpot; a contact will not be created.  # noqa: E501
        ...
        :param subscriber_state: The new subscriber state for the HubSpot contacts and the specified marketing event (required)
        ...
        :param batch_input_marketing_event_email_subscriber: The details of the contacts to subscribe to the event (required)
    ...
    def do_upsert_by_id(self, external_event_id, subscriber_state, external_account_id, batch_input_marketing_event_subscriber, **kwargs):  # noqa: E501
        ...
        Record a subscription state between multiple HubSpot contacts and a marketing event, using HubSpot contact ids. Note that the contact must already exist in HubSpot; a contact will not be create.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param external_account_id: The account id associated with the marketing event (required)
        :type external_account_id: str
        :param batch_input_marketing_event_subscriber: The details of the contacts to subscribe to the event (required)
