...
class AttendanceCounters(object):
    ...
    """
    openapi_types = {"attended": "int", "cancelled": "int", "no_shows": "int", "registered": "int"}

    attribute_map = {"attended": "attended", "cancelled": "cancelled", "no_shows": "noShows", "registered": "registered"}

    def __init__(self, attended=None, cancelled=None, no_shows=None, registered=None, local_vars_configuration=None):  # noqa: E501
