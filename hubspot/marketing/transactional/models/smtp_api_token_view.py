...
class SmtpApiTokenView(object):
    ...
    """
    openapi_types = {"campaign_name": "str", "create_contact": "bool", "created_at": "datetime", "created_by": "str", "email_campaign_id": "str", "id": "str", "password": "str"}
    ...
    def __init__(self, campaign_name=None, create_contact=None, created_at=None, created_by=None, email_campaign_id=None, id=None, password=None, local_vars_configuration=None):  # noqa: E501
