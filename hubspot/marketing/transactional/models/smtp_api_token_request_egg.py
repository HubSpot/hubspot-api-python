...
class SmtpApiTokenRequestEgg(object):
    ...
    """
    openapi_types = {"campaign_name": "str", "create_contact": "bool"}

    attribute_map = {"campaign_name": "campaignName", "create_contact": "createContact"}

    def __init__(self, campaign_name=None, create_contact=None, local_vars_configuration=None):  # noqa: E501
