...
class PublicSingleSendRequestEgg(object):
    ...
    """
    openapi_types = {"contact_properties": "dict[str, str]", "custom_properties": "dict[str, object]", "email_id": "int", "message": "PublicSingleSendEmail"}

    attribute_map = {"contact_properties": "contactProperties", "custom_properties": "customProperties", "email_id": "emailId", "message": "message"}

    def __init__(self, contact_properties=None, custom_properties=None, email_id=None, message=None, local_vars_configuration=None):  # noqa: E501
