...
class PublicSingleSendEmail(object):
    ...
    """
    openapi_types = {"bcc": "list[str]", "cc": "list[str]", "_from": "str", "reply_to": "list[str]", "send_id": "str", "to": "str"}

    attribute_map = {"bcc": "bcc", "cc": "cc", "_from": "from", "reply_to": "replyTo", "send_id": "sendId", "to": "to"}

    def __init__(self, bcc=None, cc=None, _from=None, reply_to=None, send_id=None, to=None, local_vars_configuration=None):  # noqa: E501
