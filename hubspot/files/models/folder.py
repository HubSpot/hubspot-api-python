...
class Folder(object):
    ...
    """
    openapi_types = {"archived": "bool", "archived_at": "datetime", "created_at": "datetime", "id": "str", "name": "str", "parent_folder_id": "str", "path": "str", "updated_at": "datetime"}
    ...
    def __init__(self, archived=None, archived_at=None, created_at=None, id=None, name=None, parent_folder_id=None, path=None, updated_at=None, local_vars_configuration=None):  # noqa: E501
