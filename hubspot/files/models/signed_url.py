...
class SignedUrl(object):
    ...
    """
    openapi_types = {"expires_at": "datetime", "extension": "str", "height": "int", "name": "str", "size": "int", "type": "str", "url": "str", "width": "int"}

    attribute_map = {"expires_at": "expiresAt", "extension": "extension", "height": "height", "name": "name", "size": "size", "type": "type", "url": "url", "width": "width"}

    def __init__(self, expires_at=None, extension=None, height=None, name=None, size=None, type=None, url=None, width=None, local_vars_configuration=None):  # noqa: E501
