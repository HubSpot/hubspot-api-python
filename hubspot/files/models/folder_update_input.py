...
class FolderUpdateInput(object):
    ...
    """
    openapi_types = {"name": "str", "parent_folder_id": "int"}

    attribute_map = {"name": "name", "parent_folder_id": "parentFolderId"}

    def __init__(self, name=None, parent_folder_id=None, local_vars_configuration=None):  # noqa: E501
