...
class FileActionResponse(object):
    ...
    def __init__(
        self, completed_at=None, errors=None, links=None, num_errors=None, requested_at=None, result=None, started_at=None, status=None, task_id=None, local_vars_configuration=None
    ):  # noqa: E501
