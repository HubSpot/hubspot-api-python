...
class FilesApi(object):
    ...
    def do_search(self, **kwargs):  # noqa: E501
        ...
        :param ids:
        :type ids: list[int]
        :param id_lte: Search files by less than or equal to ID. Can be used with idGte to create a range.
        :type id_lte: int
        :param id_gte: Search files by greater than or equal to ID. Can be used with idLte to create a range.
        :type id_gte: int
        :param created_at: Search files by exact time of creation. Time must be epoch time in milliseconds.
        ...
        :param updated_at: Search files by exact time of latest updated. Time must be epoch time in milliseconds.
        ...
        :param file_md5: Search files by specific md5 hash.
        :type file_md5: str
    ...
    def replace_with_http_info(self, file_id, **kwargs):  # noqa: E501
        ...
        all_params = ["file_id", "charset_hunch", "file", "options"]
        all_params.extend(["async_req", "_return_http_data_only", "_preload_content", "_request_timeout", "_request_auth", "_content_type", "_headers"])
    ...
    def upload_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ["charset_hunch", "file", "file_name", "folder_id", "folder_path", "options"]
        all_params.extend(["async_req", "_return_http_data_only", "_preload_content", "_request_timeout", "_request_auth", "_content_type", "_headers"])
