...
class FoldersApi(object):
    ...
    def do_search(self, **kwargs):  # noqa: E501
        ...
        :type ids: list[int]
        :param id_lte: Search folders by less than or equal to ID. Can be used with idGte to create a range.
        :type id_lte: int
        :param id_gte: Search folders by greater than or equal to ID. Can be used with idLte to create a range.
        :type id_gte: int
