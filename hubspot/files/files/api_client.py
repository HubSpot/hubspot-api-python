...
class ApiClient:
    ...
    def sanitize_for_serialization(self, obj):
        ...
        if isinstance(obj, dict):
            ...
            obj_dict = {obj.attribute_map[attr]: getattr(obj, attr) for attr, _ in obj.openapi_types.items() if getattr(obj, attr) is not None}
    ...
    def __deserialize_date(self, string):
        ...
        try:
            ...
            raise rest.ApiException(status=0, reason="Failed to parse `{}` as date object".format(string))
    ...
    def __deserialize_datetime(self, string):
        ...
        try:
            ...
            raise rest.ApiException(status=0, reason=("Failed to parse `{}` as datetime object".format(string)))
