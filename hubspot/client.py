...
class Client:
    ...
    def communication_preferences(self):
        from .discovery.communication_preferences.discovery import (
            Discovery as CommunicationPreferencesDiscovery,
        )
    ...
    def conversations(self):
        from .discovery.conversations.discovery import (
            Discovery as ConversationsDiscovery,
        )
