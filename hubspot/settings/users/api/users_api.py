...
class UsersApi(object):
    ...
    def update(self, user_id, public_user_update, **kwargs):  # noqa: E501
        ...
        >>> thread = api.update(user_id, public_user_update, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs["_return_http_data_only"] = True
        return self.update_with_http_info(user_id, public_user_update, **kwargs)  # noqa: E501

    def update_with_http_info(self, user_id, public_user_update, **kwargs):  # noqa: E501
        """Modifies a user  # noqa: E501
        ...
        >>> thread = api.update_with_http_info(user_id, public_user_update, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'user_id' is set
        if self.api_client.client_side_validation and local_var_params.get("user_id") is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `user_id` when calling `update`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and local_var_params.get("public_user_update") is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `public_user_update` when calling `update`")  # noqa: E501
