...
class PublicTeam(object):
    ...
    """
    openapi_types = {"id": "str", "name": "str", "secondary_user_ids": "list[str]", "user_ids": "list[str]"}

    attribute_map = {"id": "id", "name": "name", "secondary_user_ids": "secondaryUserIds", "user_ids": "userIds"}

    def __init__(self, id=None, name=None, secondary_user_ids=None, user_ids=None, local_vars_configuration=None):  # noqa: E501
