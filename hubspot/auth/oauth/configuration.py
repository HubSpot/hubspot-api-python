...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of hubspot.auth.oauth.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = hubspot.auth.oauth.Configuration(
    ...
    Note you can use the constants defined in the hubspot.auth.oauth.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = hubspot.auth.oauth.Configuration(
        signing_info = hubspot.auth.oauth.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
