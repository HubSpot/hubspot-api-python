...
class AccessTokenInfoResponse(object):
    ...
    def __init__(self, token=None, user=None, hub_domain=None, scopes=None, hub_id=None, app_id=None, expires_in=None, user_id=None, token_type=None, local_vars_configuration=None):  # noqa: E501
