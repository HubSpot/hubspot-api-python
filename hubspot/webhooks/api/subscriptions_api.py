...
class SubscriptionsApi(object):
    ...
    def delete_subscription(self, subscription_id, app_id, **kwargs):  # noqa: E501
        """Delete a subscription  # noqa: E501

        Permanently deletes a subscription. This cannot be undone.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_subscription(subscription_id, app_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.delete_subscription_with_http_info(subscription_id, app_id, **kwargs)  # noqa: E501

    def delete_subscription_with_http_info(self, subscription_id, app_id, **kwargs):  # noqa: E501
        """Delete a subscription  # noqa: E501

        Permanently deletes a subscription. This cannot be undone.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_subscription_with_http_info(subscription_id, app_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('app_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `app_id` when calling `delete_subscription`")  # noqa: E501
    ...
    def get_subscription(self, app_id, subscription_id, **kwargs):  # noqa: E501
        """Get subscription  # noqa: E501

        Returns details about a subscription.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_subscription(app_id, subscription_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_subscription_with_http_info(app_id, subscription_id, **kwargs)  # noqa: E501

    def get_subscription_with_http_info(self, app_id, subscription_id, **kwargs):  # noqa: E501
        """Get subscription  # noqa: E501

        Returns details about a subscription.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_subscription_with_http_info(app_id, subscription_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('app_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['app_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `app_id` when calling `get_subscription`")  # noqa: E501
        # verify the required parameter 'subscription_id' is set
        if self.api_client.client_side_validation and ('subscription_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['subscription_id'] is None):  # noqa: E501
    ...
    def get_subscriptions(self, app_id, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_subscriptions_with_http_info(app_id, **kwargs)  # noqa: E501

    def get_subscriptions_with_http_info(self, app_id, **kwargs):  # noqa: E501
        """Get subscription details  # noqa: E501

        Returns full details for all existing subscriptions for the given app.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_subscriptions_with_http_info(app_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('app_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['app_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `app_id` when calling `get_subscriptions`")  # noqa: E501
    ...
    def subscribe(self, app_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.subscribe(app_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param int app_id: The ID of the target app. (required)
        :param SubscriptionCreateRequest subscription_create_request: Details about the new subscription.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.subscribe_with_http_info(app_id, **kwargs)  # noqa: E501

    def subscribe_with_http_info(self, app_id, **kwargs):  # noqa: E501
        """Subscribe to an event  # noqa: E501

        Creates a new webhook subscription for the given app. Each subscription in an app must be unique.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.subscribe_with_http_info(app_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('app_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['app_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `app_id` when calling `subscribe`")  # noqa: E501
    ...
    def update_subscription(self, subscription_id, app_id, **kwargs):  # noqa: E501
        """Update a subscription  # noqa: E501

        Updates the details for an existing subscription.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_subscription(subscription_id, app_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_subscription_with_http_info(subscription_id, app_id, **kwargs)  # noqa: E501

    def update_subscription_with_http_info(self, subscription_id, app_id, **kwargs):  # noqa: E501
        """Update a subscription  # noqa: E501

        Updates the details for an existing subscription.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_subscription_with_http_info(subscription_id, app_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('app_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['app_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `app_id` when calling `update_subscription`")  # noqa: E501
