...
class SettingsResponse(object):
    ...
    """
    openapi_types = {"created_at": "datetime", "target_url": "str", "throttling": "ThrottlingSettings", "updated_at": "datetime"}

    attribute_map = {"created_at": "createdAt", "target_url": "targetUrl", "throttling": "throttling", "updated_at": "updatedAt"}

    def __init__(self, created_at=None, target_url=None, throttling=None, updated_at=None, local_vars_configuration=None):  # noqa: E501
