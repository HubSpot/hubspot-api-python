...
class BatchResponseSubscriptionResponse(object):
    ...
    """
    openapi_types = {"completed_at": "datetime", "links": "dict[str, str]", "requested_at": "datetime", "results": "list[SubscriptionResponse]", "started_at": "datetime", "status": "str"}
    ...
    def links(self):
        ...
        A collection of related links associated with the batch operation.  # noqa: E501
    ...
    def results(self):
        ...
        The list of results from the batch operation.  # noqa: E501
    ...
    def status(self):
        ...
        The current status of the batch operation, which can be PENDING, PROCESSING, CANCELED, or COMPLETE.  # noqa: E501
