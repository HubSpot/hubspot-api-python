...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of hubspot.webhooks.signing.HttpSigningConfiguration
    ...
    Note you can use the constants defined in the hubspot.webhooks.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = hubspot.webhooks.Configuration(
        signing_info = hubspot.webhooks.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
