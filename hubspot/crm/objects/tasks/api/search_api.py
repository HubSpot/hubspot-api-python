...
class SearchApi(object):
    ...
    def do_search(self, public_object_search_request, **kwargs):  # noqa: E501
        """Search for tasks using specified criteria.  # noqa: E501

        Execute a search for tasks based on the provided criteria, including filters, properties, and sorting options. This allows for retrieving tasks that match specific conditions or property values.  # noqa: E501
