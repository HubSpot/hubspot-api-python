...
class AssociationsApi(object):
    ...
    def archive(self, call_id, to_object_type, to_object_id, association_type, **kwargs):  # noqa: E501
        """Remove an association between two calls  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.archive(call_id, to_object_type, to_object_id, association_type, async_req=True)
        >>> result = thread.get()
        ...
        return self.archive_with_http_info(call_id, to_object_type, to_object_id, association_type, **kwargs)  # noqa: E501

    def archive_with_http_info(self, call_id, to_object_type, to_object_id, association_type, **kwargs):  # noqa: E501
        """Remove an association between two calls  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.archive_with_http_info(call_id, to_object_type, to_object_id, association_type, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ["call_id", "to_object_type", "to_object_id", "association_type"]  # noqa: E501
        ...
        return self.api_client.call_api(
            "/crm/v4/objects/calls/{callId}/associations/{toObjectType}/{toObjectId}",
            "DELETE",
            path_params,
            query_params,
            header_params,
    ...
    def create(self, call_id, to_object_type, to_object_id, association_type, **kwargs):  # noqa: E501
        """Associate a call with another object  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create(call_id, to_object_type, to_object_id, association_type, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs["_return_http_data_only"] = True
        return self.create_with_http_info(call_id, to_object_type, to_object_id, association_type, **kwargs)  # noqa: E501

    def create_with_http_info(self, call_id, to_object_type, to_object_id, association_type, **kwargs):  # noqa: E501
        """Associate a call with another object  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_with_http_info(call_id, to_object_type, to_object_id, association_type, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'call_id' is set
        if self.api_client.client_side_validation and ("call_id" not in local_var_params or local_var_params["call_id"] is None):  # noqa: E501  # noqa: E501
            raise ApiValueError("Missing the required parameter `call_id` when calling `create`")  # noqa: E501
        # verify the required parameter 'to_object_type' is set
        if self.api_client.client_side_validation and ("to_object_type" not in local_var_params or local_var_params["to_object_type"] is None):  # noqa: E501  # noqa: E501
    ...
    def get_all(self, call_id, to_object_type, **kwargs):  # noqa: E501
        """List associations of a call by type  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all(call_id, to_object_type, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs["_return_http_data_only"] = True
        return self.get_all_with_http_info(call_id, to_object_type, **kwargs)  # noqa: E501

    def get_all_with_http_info(self, call_id, to_object_type, **kwargs):  # noqa: E501
        """List associations of a call by type  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_with_http_info(call_id, to_object_type, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ["call_id", "to_object_type", "after", "limit"]  # noqa: E501
        all_params.append("async_req")
        all_params.append("_return_http_data_only")
        all_params.append("_preload_content")
        all_params.append("_request_timeout")
        ...
        # verify the required parameter 'call_id' is set
        if self.api_client.client_side_validation and ("call_id" not in local_var_params or local_var_params["call_id"] is None):  # noqa: E501  # noqa: E501
            raise ApiValueError("Missing the required parameter `call_id` when calling `get_all`")  # noqa: E501
        # verify the required parameter 'to_object_type' is set
        if self.api_client.client_side_validation and ("to_object_type" not in local_var_params or local_var_params["to_object_type"] is None):  # noqa: E501  # noqa: E501
        ...
        return self.api_client.call_api(
            "/crm/v4/objects/calls/{callId}/associations/{toObjectType}",
            "GET",
            path_params,
            query_params,
            header_params,
