...
class PublicObjectApi(object):
    ...
    def post_crm_v3_objects_feedback_submissions_merge(self, public_merge_input, **kwargs):  # noqa: E501
        ...
        >>> thread = api.post_crm_v3_objects_feedback_submissions_merge(public_merge_input, async_req=True)
        >>> result = thread.get()
    ...
    def post_crm_v3_objects_feedback_submissions_merge_with_http_info(self, public_merge_input, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_crm_v3_objects_feedback_submissions_merge_with_http_info(public_merge_input, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/crm/v3/objects/feedback submissions/merge', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
