...
class BatchApi(object):
    ...
    def post_crm_v3_objects_feedback_submissions_batch_archive(
        ...
        return (
            self.post_crm_v3_objects_feedback_submissions_batch_archive_with_http_info(
                batch_input_simple_public_object_id, **kwargs
            )
        )  # noqa: E501

    def post_crm_v3_objects_feedback_submissions_batch_archive_with_http_info(
        self, batch_input_simple_public_object_id, **kwargs
    ):  # noqa: E501
        """Archive a batch of feedback submissions by ID  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params["kwargs"]):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method post_crm_v3_objects_feedback_submissions_batch_archive"
                    % key
                )
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `batch_input_simple_public_object_id` when calling `post_crm_v3_objects_feedback_submissions_batch_archive`"
            )  # noqa: E501
    ...
    def post_crm_v3_objects_feedback_submissions_batch_create(
        ...
        kwargs["_return_http_data_only"] = True
        return (
            self.post_crm_v3_objects_feedback_submissions_batch_create_with_http_info(
                batch_input_simple_public_object_input_for_create, **kwargs
            )
        )  # noqa: E501

    def post_crm_v3_objects_feedback_submissions_batch_create_with_http_info(
        self, batch_input_simple_public_object_input_for_create, **kwargs
    ):  # noqa: E501
        """Create a batch of feedback submissions  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params["kwargs"]):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_crm_v3_objects_feedback_submissions_batch_create"
                    % key
                )
            local_var_params[key] = val
        del local_var_params["kwargs"]
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `batch_input_simple_public_object_input_for_create` when calling `post_crm_v3_objects_feedback_submissions_batch_create`"
            )  # noqa: E501
    ...
    def post_crm_v3_objects_feedback_submissions_batch_read(
        ...
        """
        kwargs["_return_http_data_only"] = True
        return self.post_crm_v3_objects_feedback_submissions_batch_read_with_http_info(
            batch_read_input_simple_public_object_id, **kwargs
        )  # noqa: E501

    def post_crm_v3_objects_feedback_submissions_batch_read_with_http_info(
        self, batch_read_input_simple_public_object_id, **kwargs
    ):  # noqa: E501
        """Read a batch of feedback submissions by internal ID, or unique property values  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params["kwargs"]):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_crm_v3_objects_feedback_submissions_batch_read"
                    % key
                )
            local_var_params[key] = val
        del local_var_params["kwargs"]
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `batch_read_input_simple_public_object_id` when calling `post_crm_v3_objects_feedback_submissions_batch_read`"
            )  # noqa: E501
    ...
    def post_crm_v3_objects_feedback_submissions_batch_update(
        ...
        kwargs["_return_http_data_only"] = True
        return (
            self.post_crm_v3_objects_feedback_submissions_batch_update_with_http_info(
                batch_input_simple_public_object_batch_input, **kwargs
            )
        )  # noqa: E501

    def post_crm_v3_objects_feedback_submissions_batch_update_with_http_info(
        self, batch_input_simple_public_object_batch_input, **kwargs
    ):  # noqa: E501
        """Update a batch of feedback submissions  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params["kwargs"]):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_crm_v3_objects_feedback_submissions_batch_update"
                    % key
                )
            local_var_params[key] = val
        del local_var_params["kwargs"]
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `batch_input_simple_public_object_batch_input` when calling `post_crm_v3_objects_feedback_submissions_batch_update`"
            )  # noqa: E501
