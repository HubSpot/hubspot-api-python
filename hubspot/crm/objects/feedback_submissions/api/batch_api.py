...
class BatchApi(object):
    ...
    def post_crm_v3_objects_feedback_submissions_batch_archive_with_http_info(self, batch_input_simple_public_object_id, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method post_crm_v3_objects_feedback_submissions_batch_archive" % key
                )
        ...
        return self.api_client.call_api(
            '/crm/v3/objects/feedback submissions/batch/archive', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def post_crm_v3_objects_feedback_submissions_batch_create_with_http_info(self, batch_input_simple_public_object_input_for_create, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_crm_v3_objects_feedback_submissions_batch_create" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        return self.api_client.call_api(
            '/crm/v3/objects/feedback submissions/batch/create', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def post_crm_v3_objects_feedback_submissions_batch_read_with_http_info(self, batch_read_input_simple_public_object_id, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_crm_v3_objects_feedback_submissions_batch_read" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        return self.api_client.call_api(
            '/crm/v3/objects/feedback submissions/batch/read', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def post_crm_v3_objects_feedback_submissions_batch_update_with_http_info(self, batch_input_simple_public_object_batch_input, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_crm_v3_objects_feedback_submissions_batch_update" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        return self.api_client.call_api(
            '/crm/v3/objects/feedback submissions/batch/update', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
