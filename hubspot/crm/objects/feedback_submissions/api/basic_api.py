...
class BasicApi(object):
    ...
    def get_by_id_with_http_info(self, feedback_submission_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and "feedback_submission_id" in local_var_params and not re.search(r".+", local_var_params["feedback_submission_id"]):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `feedback_submission_id` when calling `get_by_id`, must conform to the pattern `/.+/`")  # noqa: E501
        collection_formats = {}
