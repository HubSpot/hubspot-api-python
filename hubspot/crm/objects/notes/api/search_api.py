...
class SearchApi(object):
    ...
    def do_search(self, public_object_search_request, **kwargs):  # noqa: E501
        """Search for notes based on specified criteria.  # noqa: E501

        Execute a search for notes using filters, sorting options, and other query parameters to refine the results. This endpoint allows for complex queries to locate specific notes within the CRM system.  # noqa: E501
