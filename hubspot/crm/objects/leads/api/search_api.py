...
class SearchApi(object):
    ...
    def do_search(self, public_object_search_request, **kwargs):  # noqa: E501
        """Search for leads using specified criteria.  # noqa: E501

        Perform a search for leads based on the provided filter groups, properties, and sorting options. The request allows for pagination and can return up to 200 results per page.  # noqa: E501
