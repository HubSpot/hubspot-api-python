...
class BasicApi(object):
    ...
    def archive(self, goal_target_id, **kwargs):  # noqa: E501
        """Delete a goal target by ID  # noqa: E501

        Delete a goal target by `{goalTargetId}` to the recycling bin.  # noqa: E501
    ...
    def archive_with_http_info(self, goal_target_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and "goal_target_id" in local_var_params and not re.search(r".+", local_var_params["goal_target_id"]):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `goal_target_id` when calling `archive`, must conform to the pattern `/.+/`")  # noqa: E501
        collection_formats = {}
    ...
    def get_by_id_with_http_info(self, goal_target_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and "goal_target_id" in local_var_params and not re.search(r".+", local_var_params["goal_target_id"]):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `goal_target_id` when calling `get_by_id`, must conform to the pattern `/.+/`")  # noqa: E501
        collection_formats = {}
    ...
    def get_page(self, **kwargs):  # noqa: E501
        """Get a page of goal targets  # noqa: E501
    ...
    def update_with_http_info(self, goal_target_id, simple_public_object_input, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and "goal_target_id" in local_var_params and not re.search(r".+", local_var_params["goal_target_id"]):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `goal_target_id` when calling `update`, must conform to the pattern `/.+/`")  # noqa: E501
        collection_formats = {}
