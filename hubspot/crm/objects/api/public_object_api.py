...
class PublicObjectApi(object):
    ...
    def merge(self, object_type, public_merge_input, **kwargs):  # noqa: E501
        ...
        return self.merge_with_http_info(
            object_type, public_merge_input, **kwargs
        )  # noqa: E501

    def merge_with_http_info(
        self, object_type, public_merge_input, **kwargs
    ):  # noqa: E501
        """Merge two objects with same type  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params["kwargs"]):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'" " to method merge" % key
                )
