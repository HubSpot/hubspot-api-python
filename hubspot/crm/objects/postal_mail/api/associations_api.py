...
class AssociationsApi(object):
    ...
    def archive(self, postal_mail, to_object_type, to_object_id, **kwargs):  # noqa: E501
        """Delete  # noqa: E501

        deletes all associations between two records.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.archive(postal_mail, to_object_type, to_object_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.archive_with_http_info(postal_mail, to_object_type, to_object_id, **kwargs)  # noqa: E501

    def archive_with_http_info(self, postal_mail, to_object_type, to_object_id, **kwargs):  # noqa: E501
        """Delete  # noqa: E501

        deletes all associations between two records.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.archive_with_http_info(postal_mail, to_object_type, to_object_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ["postal_mail", "to_object_type", "to_object_id"]  # noqa: E501
        ...
        if self.api_client.client_side_validation and ("postal_mail" not in local_var_params or local_var_params["postal_mail"] is None):  # noqa: E501  # noqa: E501
        ...
        return self.api_client.call_api(
            "/crm/v4/objects/postal_mail/{postalMail}/associations/{toObjectType}/{toObjectId}",
            "DELETE",
            path_params,
            query_params,
            header_params,
    ...
    def create(self, postal_mail, to_object_type, to_object_id, association_spec, **kwargs):  # noqa: E501
        """Create  # noqa: E501

        Set association labels between two records.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create(postal_mail, to_object_type, to_object_id, association_spec, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs["_return_http_data_only"] = True
        return self.create_with_http_info(postal_mail, to_object_type, to_object_id, association_spec, **kwargs)  # noqa: E501

    def create_with_http_info(self, postal_mail, to_object_type, to_object_id, association_spec, **kwargs):  # noqa: E501
        """Create  # noqa: E501

        Set association labels between two records.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_with_http_info(postal_mail, to_object_type, to_object_id, association_spec, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ["postal_mail", "to_object_type", "to_object_id", "association_spec"]  # noqa: E501
        all_params.append("async_req")
        all_params.append("_return_http_data_only")
        all_params.append("_preload_content")
        all_params.append("_request_timeout")
        ...
        # verify the required parameter 'postal_mail' is set
        if self.api_client.client_side_validation and ("postal_mail" not in local_var_params or local_var_params["postal_mail"] is None):  # noqa: E501  # noqa: E501
            raise ApiValueError("Missing the required parameter `postal_mail` when calling `create`")  # noqa: E501
        # verify the required parameter 'to_object_type' is set
        if self.api_client.client_side_validation and ("to_object_type" not in local_var_params or local_var_params["to_object_type"] is None):  # noqa: E501  # noqa: E501
    ...
    def get_all(self, postal_mail, to_object_type, **kwargs):  # noqa: E501
        """List  # noqa: E501

        List all associations of a postal mail by object type. Limit 1000 per call.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all(postal_mail, to_object_type, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs["_return_http_data_only"] = True
        return self.get_all_with_http_info(postal_mail, to_object_type, **kwargs)  # noqa: E501

    def get_all_with_http_info(self, postal_mail, to_object_type, **kwargs):  # noqa: E501
        """List  # noqa: E501

        List all associations of a postal mail by object type. Limit 1000 per call.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_with_http_info(postal_mail, to_object_type, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ["postal_mail", "to_object_type", "after", "limit"]  # noqa: E501
        all_params.append("async_req")
        all_params.append("_return_http_data_only")
        all_params.append("_preload_content")
        all_params.append("_request_timeout")
        ...
        # verify the required parameter 'postal_mail' is set
        if self.api_client.client_side_validation and ("postal_mail" not in local_var_params or local_var_params["postal_mail"] is None):  # noqa: E501  # noqa: E501
            raise ApiValueError("Missing the required parameter `postal_mail` when calling `get_all`")  # noqa: E501
        # verify the required parameter 'to_object_type' is set
        if self.api_client.client_side_validation and ("to_object_type" not in local_var_params or local_var_params["to_object_type"] is None):  # noqa: E501  # noqa: E501
        ...
        return self.api_client.call_api(
            "/crm/v4/objects/postal_mail/{postalMail}/associations/{toObjectType}",
            "GET",
            path_params,
            query_params,
            header_params,
