...
class BatchReadInputSimplePublicObjectId(object):
    ...
    """
    openapi_types = {"id_property": "str", "inputs": "list[SimplePublicObjectId]", "properties": "list[str]", "properties_with_history": "list[str]"}

    attribute_map = {"id_property": "idProperty", "inputs": "inputs", "properties": "properties", "properties_with_history": "propertiesWithHistory"}

    def __init__(self, id_property=None, inputs=None, properties=None, properties_with_history=None, local_vars_configuration=None):  # noqa: E501
    ...
    def properties_with_history(self):
        ...
        Key-value pairs for setting properties for the new object and their histories.  # noqa: E501
