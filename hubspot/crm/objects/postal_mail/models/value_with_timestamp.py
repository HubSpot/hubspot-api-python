...
class ValueWithTimestamp(object):
    ...
    """
    openapi_types = {"source_id": "str", "source_label": "str", "source_type": "str", "timestamp": "datetime", "updated_by_user_id": "int", "value": "str"}

    attribute_map = {"source_id": "sourceId", "source_label": "sourceLabel", "source_type": "sourceType", "timestamp": "timestamp", "updated_by_user_id": "updatedByUserId", "value": "value"}

    def __init__(self, source_id=None, source_label=None, source_type=None, timestamp=None, updated_by_user_id=None, value=None, local_vars_configuration=None):  # noqa: E501
    ...
    def source_id(self):
        ...
        The unique ID of the property.  # noqa: E501
    ...
    def source_label(self):
        ...
        A human-readable label.  # noqa: E501
    ...
    def timestamp(self):
        ...
        The timestamp when the property was updated, in ISO 8601 format.  # noqa: E501
