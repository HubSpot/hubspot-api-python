...
class BasicApi(object):
    ...
    def archive_with_http_info(self, meeting_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and "meeting_id" in local_var_params and not re.search(r".+", local_var_params["meeting_id"]):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `meeting_id` when calling `archive`, must conform to the pattern `/.+/`")  # noqa: E501
        collection_formats = {}
    ...
    def get_by_id_with_http_info(self, meeting_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and "meeting_id" in local_var_params and not re.search(r".+", local_var_params["meeting_id"]):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `meeting_id` when calling `get_by_id`, must conform to the pattern `/.+/`")  # noqa: E501
        collection_formats = {}
    ...
    def update_with_http_info(self, meeting_id, simple_public_object_input, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and "meeting_id" in local_var_params and not re.search(r".+", local_var_params["meeting_id"]):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `meeting_id` when calling `update`, must conform to the pattern `/.+/`")  # noqa: E501
        collection_formats = {}
