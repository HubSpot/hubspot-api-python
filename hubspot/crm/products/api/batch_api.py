...
class BatchApi(object):
    ...
    def archive_with_http_info(self, batch_input_simple_public_object_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/crm/v3/objects/products/batch/archive', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def create_with_http_info(self, batch_input_simple_public_object_input, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/crm/v3/objects/products/batch/create', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def read_with_http_info(self, batch_read_input_simple_public_object_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/crm/v3/objects/products/batch/read', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_with_http_info(self, batch_input_simple_public_object_batch_input, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/crm/v3/objects/products/batch/update', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
