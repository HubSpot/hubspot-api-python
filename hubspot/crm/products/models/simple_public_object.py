...
class SimplePublicObject(object):
    ...
    """
    openapi_types = {"id": "str", "properties": "dict(str, str)", "created_at": "datetime", "updated_at": "datetime", "archived": "bool", "archived_at": "datetime"}

    attribute_map = {"id": "id", "properties": "properties", "created_at": "createdAt", "updated_at": "updatedAt", "archived": "archived", "archived_at": "archivedAt"}

    def __init__(self, id=None, properties=None, created_at=None, updated_at=None, archived=None, archived_at=None, local_vars_configuration=None):  # noqa: E501
