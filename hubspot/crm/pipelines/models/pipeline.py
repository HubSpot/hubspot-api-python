...
class Pipeline(object):
    ...
    def __init__(self, stages=None, created_at=None, archived_at=None, updated_at=None, archived=None, label=None, display_order=None, id=None, local_vars_configuration=None):  # noqa: E501
