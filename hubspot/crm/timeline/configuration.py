...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of hubspot.crm.timeline.signing.HttpSigningConfiguration
    ...
    Note you can use the constants defined in the hubspot.crm.timeline.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = hubspot.crm.timeline.Configuration(
        signing_info = hubspot.crm.timeline.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
