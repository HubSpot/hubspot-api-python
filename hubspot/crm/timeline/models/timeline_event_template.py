...
class TimelineEventTemplate(object):
    ...
    def __init__(self, id=None, object_type=None, created_at=None, updated_at=None, name=None, header_template=None, detail_template=None, tokens=None, local_vars_configuration=None):  # noqa: E501
