...
class TokensApi(object):
    ...
    def create_with_http_info(self, event_template_id, app_id, timeline_event_template_token, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('timeline_event_template_token' not in local_var_params or  # noqa: E501
                                                        local_var_params['timeline_event_template_token'] is None):  # noqa: E501
    ...
    def update_with_http_info(self, event_template_id, token_name, app_id, timeline_event_template_token_update_request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('timeline_event_template_token_update_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['timeline_event_template_token_update_request'] is None):  # noqa: E501
