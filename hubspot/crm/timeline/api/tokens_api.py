...
class TokensApi(object):
    ...
    def create(self, event_template_id, token_name, app_id, timeline_event_template_token_update_request, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create(event_template_id, token_name, app_id, timeline_event_template_token_update_request, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs["_return_http_data_only"] = True
        return self.create_with_http_info(event_template_id, token_name, app_id, timeline_event_template_token_update_request, **kwargs)  # noqa: E501

    def create_with_http_info(self, event_template_id, token_name, app_id, timeline_event_template_token_update_request, **kwargs):  # noqa: E501
        """Updates an existing token on an event template  # noqa: E501
        ...
        >>> thread = api.create_with_http_info(event_template_id, token_name, app_id, timeline_event_template_token_update_request, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'token_name' is set
        if self.api_client.client_side_validation and local_var_params.get("token_name") is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `token_name` when calling `create`")  # noqa: E501
        # verify the required parameter 'app_id' is set
        if self.api_client.client_side_validation and local_var_params.get("app_id") is None:  # noqa: E501
        ...
        if self.api_client.client_side_validation and local_var_params.get("timeline_event_template_token_update_request") is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `timeline_event_template_token_update_request` when calling `create`")  # noqa: E501
    ...
    def create_0(self, event_template_id, app_id, timeline_event_template_token, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create_0(event_template_id, app_id, timeline_event_template_token, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs["_return_http_data_only"] = True
        return self.create_0_with_http_info(event_template_id, app_id, timeline_event_template_token, **kwargs)  # noqa: E501

    def create_0_with_http_info(self, event_template_id, app_id, timeline_event_template_token, **kwargs):  # noqa: E501
        """Adds a token to an existing event template  # noqa: E501
        ...
        >>> thread = api.create_0_with_http_info(event_template_id, app_id, timeline_event_template_token, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params["kwargs"]):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method create_0" % key)
            local_var_params[key] = val
        del local_var_params["kwargs"]
        # verify the required parameter 'event_template_id' is set
        if self.api_client.client_side_validation and local_var_params.get("event_template_id") is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `event_template_id` when calling `create_0`")  # noqa: E501
        # verify the required parameter 'app_id' is set
        if self.api_client.client_side_validation and local_var_params.get("app_id") is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `app_id` when calling `create_0`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and local_var_params.get("timeline_event_template_token") is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `timeline_event_template_token` when calling `create_0`")  # noqa: E501
