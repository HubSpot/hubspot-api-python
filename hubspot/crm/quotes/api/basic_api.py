...
class BasicApi(object):
    ...
    def archive(self, quote_id, **kwargs):  # noqa: E501
        """Archive  # noqa: E501
        ...
        return self.archive_with_http_info(quote_id, **kwargs)  # noqa: E501

    def archive_with_http_info(self, quote_id, **kwargs):  # noqa: E501
        """Archive  # noqa: E501
        ...
        return self.api_client.call_api(
            '/crm/v3/objects/quotes/{quoteId}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def create(self, **kwargs):  # noqa: E501
        ...
        Create a quote with the given properties and return a copy of the object, including the ID. Documentation and examples for creating native quotes is provided.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_by_id_with_http_info(self, quote_id, **kwargs):  # noqa: E501
        ...
        all_params = ['quote_id', 'properties', 'associations', 'archived', 'id_property']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api(
            '/crm/v3/objects/quotes/{quoteId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update(self, quote_id, **kwargs):  # noqa: E501
        """Update  # noqa: E501

        Perform a partial update of an Object identified by `{quoteId}`. Provided property values will be overwritten. Read-only and non-existent properties will be ignored. Properties values can be cleared by passing an empty string.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update(quote_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_with_http_info(quote_id, **kwargs)  # noqa: E501

    def update_with_http_info(self, quote_id, **kwargs):  # noqa: E501
        """Update  # noqa: E501

        Perform a partial update of an Object identified by `{quoteId}`. Provided property values will be overwritten. Read-only and non-existent properties will be ignored. Properties values can be cleared by passing an empty string.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_with_http_info(quote_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['quote_id', 'simple_public_object_input']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api(
            '/crm/v3/objects/quotes/{quoteId}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
