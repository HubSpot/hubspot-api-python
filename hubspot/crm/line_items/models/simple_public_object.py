...
class SimplePublicObject(object):
    ...
    def __init__(
        self, archived=None, archived_at=None, created_at=None, id=None, object_write_trace_id=None, properties=None, properties_with_history=None, updated_at=None, local_vars_configuration=None
    ):  # noqa: E501
