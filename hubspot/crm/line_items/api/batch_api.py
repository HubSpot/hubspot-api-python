...
class BatchApi(object):
    ...
    def items_batch_upsert(self, batch_input_simple_public_object_batch_input_upsert, **kwargs):  # noqa: E501
        ...
        >>> thread = api.items_batch_upsert(batch_input_simple_public_object_batch_input_upsert, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs["_return_http_data_only"] = True
        return self.items_batch_upsert_with_http_info(batch_input_simple_public_object_batch_input_upsert, **kwargs)  # noqa: E501

    def items_batch_upsert_with_http_info(self, batch_input_simple_public_object_batch_input_upsert, **kwargs):  # noqa: E501
        """Create or update a batch of line items by unique property values  # noqa: E501
        ...
        >>> thread = api.items_batch_upsert_with_http_info(batch_input_simple_public_object_batch_input_upsert, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params["kwargs"]):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method items_batch_upsert" % key)
            local_var_params[key] = val
        del local_var_params["kwargs"]
        ...
        if self.api_client.client_side_validation and local_var_params.get("batch_input_simple_public_object_batch_input_upsert") is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `batch_input_simple_public_object_batch_input_upsert` when calling `items_batch_upsert`")  # noqa: E501
