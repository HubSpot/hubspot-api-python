...
class BatchApi(object):
    ...
    def archive(self, batch_input_simple_public_object_id, **kwargs):  # noqa: E501
        ...
        Archive a list of line items given a collection of IDs. This method will return a `204 No Content` response on success regardless of the initial state of the object (e.g. active, already archived, non-existent).  # noqa: E501
    ...
    def archive_with_http_info(self, batch_input_simple_public_object_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/crm/v3/objects/line_items/batch/archive', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def create(self, batch_input_simple_public_object_input, **kwargs):  # noqa: E501
        ...
        Create a batch of line items. This follows the same rules as creating an individual object.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def create_with_http_info(self, batch_input_simple_public_object_input, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('batch_input_simple_public_object_input' not in local_var_params or  # noqa: E501
                                                        local_var_params['batch_input_simple_public_object_input'] is None):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/crm/v3/objects/line_items/batch/create', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def read(self, batch_read_input_simple_public_object_id, **kwargs):  # noqa: E501
        ...
        Read a list of line items given a collection of IDs. Use the `properties` request body property to control which properties are returned.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def read_with_http_info(self, batch_read_input_simple_public_object_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/crm/v3/objects/line_items/batch/read', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_with_http_info(self, batch_input_simple_public_object_batch_input, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/crm/v3/objects/line_items/batch/update', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
