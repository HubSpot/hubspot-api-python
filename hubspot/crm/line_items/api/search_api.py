...
class SearchApi(object):
    ...
    def do_search(self, public_object_search_request, **kwargs):  # noqa: E501
        """Search for line items using specified criteria.  # noqa: E501

        Execute a search for line items based on filters, properties, and sorting options provided in the request body. This endpoint allows you to retrieve line items that match specific conditions, facilitating targeted data retrieval in CRM operations.  # noqa: E501
