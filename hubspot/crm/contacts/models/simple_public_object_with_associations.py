...
class SimplePublicObjectWithAssociations(object):
    ...
    def associations(self):
        ...
        A list defining relationships with other objects.  # noqa: E501
    ...
    @property
    def url(self):
        """Gets the url of this SimplePublicObjectWithAssociations.  # noqa: E501

        The URL on the API that provide direct navigation to the corresponding UI pages for the connectors.  # noqa: E501

        :return: The url of this SimplePublicObjectWithAssociations.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this SimplePublicObjectWithAssociations.

        The URL on the API that provide direct navigation to the corresponding UI pages for the connectors.  # noqa: E501

        :param url: The url of this SimplePublicObjectWithAssociations.  # noqa: E501
        :type url: str
        """
