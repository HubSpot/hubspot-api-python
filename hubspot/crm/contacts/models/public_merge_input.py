...
class PublicMergeInput(object):
    ...
    def object_id_to_merge(self):
        ...
        The object ID of the record that the merge will not set as the current value after the merge.  # noqa: E501
    ...
    def primary_object_id(self):
        ...
        The object ID of the record that the merge will generally set as the current value after the merge.  # noqa: E501
