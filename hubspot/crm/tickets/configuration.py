...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of hubspot.crm.tickets.signing.HttpSigningConfiguration
    ...
    Note you can use the constants defined in the hubspot.crm.tickets.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = hubspot.crm.tickets.Configuration(
        signing_info = hubspot.crm.tickets.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
