...
class AssociationsApi(object):
    ...
    def archive(
        ...
        return self.archive_with_http_info(
            ticket_id, to_object_type, to_object_id, association_type, **kwargs
        )  # noqa: E501
    ...
    def archive_with_http_info(
        ...
        all_params = ["ticket_id", "to_object_type", "to_object_id", "association_type"]
        all_params.extend(
            [
                "async_req",
    ...
    def get_all(self, ticket_id, to_object_type, **kwargs):  # noqa: E501
        ...
        return self.get_all_with_http_info(
            ticket_id, to_object_type, **kwargs
        )  # noqa: E501
    ...
    def get_all_with_http_info(self, ticket_id, to_object_type, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `ticket_id` when calling `get_all`"
            )  # noqa: E501
        # verify the required parameter 'to_object_type' is set
        if self.api_client.client_side_validation and (
            "to_object_type" not in local_var_params
