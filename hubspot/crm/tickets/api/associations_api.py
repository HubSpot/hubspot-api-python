...
from hubspot.crm.tickets.exceptions import (
    ApiTypeError,
    ApiValueError
)
...
class AssociationsApi(object):
    ...
    def archive_association(self, ticket_id, to_object_type, to_object_id, association_type, **kwargs):  # noqa: E501
        """Remove an association between two tickets  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.archive_association(ticket_id, to_object_type, to_object_id, association_type, async_req=True)
        >>> result = thread.get()
        ...
        return self.archive_association_with_http_info(ticket_id, to_object_type, to_object_id, association_type, **kwargs)  # noqa: E501

    def archive_association_with_http_info(self, ticket_id, to_object_type, to_object_id, association_type, **kwargs):  # noqa: E501
        """Remove an association between two tickets  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.archive_association_with_http_info(ticket_id, to_object_type, to_object_id, association_type, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('ticket_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `ticket_id` when calling `archive_association`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/crm/v3/objects/tickets/{ticketId}/associations/{toObjectType}/{toObjectId}/{associationType}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def create_association(self, ticket_id, to_object_type, to_object_id, association_type, **kwargs):  # noqa: E501
        """Associate two tickets  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_association(ticket_id, to_object_type, to_object_id, association_type, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.create_association_with_http_info(ticket_id, to_object_type, to_object_id, association_type, **kwargs)  # noqa: E501

    def create_association_with_http_info(self, ticket_id, to_object_type, to_object_id, association_type, **kwargs):  # noqa: E501
        """Associate two tickets  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_association_with_http_info(ticket_id, to_object_type, to_object_id, association_type, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('ticket_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['ticket_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `ticket_id` when calling `create_association`")  # noqa: E501
        # verify the required parameter 'to_object_type' is set
        if self.api_client.client_side_validation and ('to_object_type' not in local_var_params or  # noqa: E501
                                                        local_var_params['to_object_type'] is None):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/crm/v3/objects/tickets/{ticketId}/associations/{toObjectType}/{toObjectId}/{associationType}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_associations(self, ticket_id, to_object_type, **kwargs):  # noqa: E501
        """List associations of a ticket by type  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_associations(ticket_id, to_object_type, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_associations_with_http_info(ticket_id, to_object_type, **kwargs)  # noqa: E501

    def get_associations_with_http_info(self, ticket_id, to_object_type, **kwargs):  # noqa: E501
        """List associations of a ticket by type  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_associations_with_http_info(ticket_id, to_object_type, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['ticket_id', 'to_object_type']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('ticket_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['ticket_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `ticket_id` when calling `get_associations`")  # noqa: E501
        # verify the required parameter 'to_object_type' is set
        if self.api_client.client_side_validation and ('to_object_type' not in local_var_params or  # noqa: E501
                                                        local_var_params['to_object_type'] is None):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/crm/v3/objects/tickets/{ticketId}/associations/{toObjectType}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
