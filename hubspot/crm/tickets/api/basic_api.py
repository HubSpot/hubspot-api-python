...
class BasicApi(object):
    ...
    def get_by_id(self, ticket_id, **kwargs):  # noqa: E501
        ...
        Read an Object identified by `{ticketId}`. Control what is returned via the `properties` query param.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_by_id_with_http_info(self, ticket_id, **kwargs):  # noqa: E501
        ...
        all_params = ['ticket_id', 'properties', 'associations', 'archived']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
