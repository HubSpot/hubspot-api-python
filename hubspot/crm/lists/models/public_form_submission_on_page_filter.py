...
class PublicFormSubmissionOnPageFilter(object):
    ...
    def __init__(
        self, filter_type="FORM_SUBMISSION_ON_PAGE", form_id=None, pruning_refine_by=None, coalescing_refine_by=None, operator=None, page_id=None, local_vars_configuration=None
    ):  # noqa: E501
