...
class PublicUnifiedEventsFilter(object):
    ...
    attribute_map = {"filter_type": "filterType", "pruning_refine_by": "pruningRefineBy", "coalescing_refine_by": "coalescingRefineBy", "event_type_id": "eventTypeId", "filter_lines": "filterLines"}

    def __init__(self, filter_type="UNIFIED_EVENTS", pruning_refine_by=None, coalescing_refine_by=None, event_type_id=None, filter_lines=None, local_vars_configuration=None):  # noqa: E501
