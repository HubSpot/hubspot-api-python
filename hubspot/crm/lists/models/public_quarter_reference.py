...
class PublicQuarterReference(object):
    ...
    def __init__(self, reference_type="QUARTER", hour=None, minute=None, second=None, millisecond=None, month=None, day=None, local_vars_configuration=None):  # noqa: E501
