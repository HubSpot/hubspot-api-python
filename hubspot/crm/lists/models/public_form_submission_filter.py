...
class PublicFormSubmissionFilter(object):
    ...
    attribute_map = {"filter_type": "filterType", "form_id": "formId", "pruning_refine_by": "pruningRefineBy", "coalescing_refine_by": "coalescingRefineBy", "operator": "operator"}

    def __init__(self, filter_type="FORM_SUBMISSION", form_id=None, pruning_refine_by=None, coalescing_refine_by=None, operator=None, local_vars_configuration=None):  # noqa: E501
