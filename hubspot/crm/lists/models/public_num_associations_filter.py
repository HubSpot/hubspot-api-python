...
class PublicNumAssociationsFilter(object):
    ...
    """
    openapi_types = {"filter_type": "str", "association_type_id": "int", "association_category": "str", "coalescing_refine_by": "PublicEventAnalyticsFilterCoalescingRefineBy"}

    attribute_map = {"filter_type": "filterType", "association_type_id": "associationTypeId", "association_category": "associationCategory", "coalescing_refine_by": "coalescingRefineBy"}

    def __init__(self, filter_type="NUM_ASSOCIATIONS", association_type_id=None, association_category=None, coalescing_refine_by=None, local_vars_configuration=None):  # noqa: E501
