...
class PublicUnifiedEventsFilterBranch(object):
    ...
    def __init__(
        self, filter_branch_type="UNIFIED_EVENTS", filter_branches=None, filters=None, event_type_id=None, operator=None, filter_branch_operator=None, local_vars_configuration=None
    ):  # noqa: E501
