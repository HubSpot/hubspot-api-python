...
class PublicAdsTimeFilter(object):
    ...
    attribute_map = {"filter_type": "filterType", "pruning_refine_by": "pruningRefineBy"}

    def __init__(self, filter_type="ADS_TIME", pruning_refine_by=None, local_vars_configuration=None):  # noqa: E501
