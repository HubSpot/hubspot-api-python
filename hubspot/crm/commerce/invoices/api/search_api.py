...
class SearchApi(object):
    ...
    def do_search(self, public_object_search_request, **kwargs):  # noqa: E501
        """Search for invoices using specified criteria.  # noqa: E501

        Execute a search for invoices based on filter criteria, sorting options, and properties to include in the response. This endpoint supports pagination and allows for complex queries using multiple filter groups.  # noqa: E501
