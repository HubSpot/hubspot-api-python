...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of hubspot.crm.extensions.cards.signing.HttpSigningConfiguration
    ...
    Note you can use the constants defined in the hubspot.crm.extensions.cards.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = hubspot.crm.extensions.cards.Configuration(
        signing_info = hubspot.crm.extensions.cards.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="https://api.hubapi.com/crm/v3/extensions/cards",
