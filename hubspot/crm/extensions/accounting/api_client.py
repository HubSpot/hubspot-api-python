...
import hubspot.crm.extensions.accounting.models
from hubspot.crm.extensions.accounting import rest
from hubspot.crm.extensions.accounting.exceptions import ApiValueError, ApiException
...
class ApiClient:
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(hubspot.crm.extensions.accounting.models, klass)
    ...
    def __deserialize_datetime(self, string):
        ...
        try:
            ...
            raise rest.ApiException(
                status=0,
                reason=("Failed to parse `{}` as datetime object".format(string)),
            )
