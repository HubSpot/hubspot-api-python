...
class SettingsApi(object):
    ...
    def replace_with_http_info(self, app_id, accounting_app_settings, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('accounting_app_settings' not in local_var_params or  # noqa: E501
                                                        local_var_params['accounting_app_settings'] is None):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/crm/v3/extensions/accounting/settings/{appId}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
