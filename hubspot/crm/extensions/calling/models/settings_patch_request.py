...
class SettingsPatchRequest(object):
    ...
    """
    openapi_types = {"supports_custom_objects": "bool", "is_ready": "bool", "name": "str", "width": "int", "url": "str", "height": "int"}

    attribute_map = {"supports_custom_objects": "supportsCustomObjects", "is_ready": "isReady", "name": "name", "width": "width", "url": "url", "height": "height"}

    def __init__(self, supports_custom_objects=None, is_ready=None, name=None, width=None, url=None, height=None, local_vars_configuration=None):  # noqa: E501
