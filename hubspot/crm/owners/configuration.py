...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of hubspot.crm.owners.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = hubspot.crm.owners.Configuration(
    ...
    Note you can use the constants defined in the hubspot.crm.owners.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = hubspot.crm.owners.Configuration(
        signing_info = hubspot.crm.owners.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="https://api.hubapi.com/crm/v3/owners",
